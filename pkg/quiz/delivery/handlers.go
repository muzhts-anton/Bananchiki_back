...
func SetQuizHandlers(router *mux.Router, uc domain.QuizUsecase) {
	...
	router.HandleFunc(urlCompetitionStart, handler.competitionStart).Methods("PUT", "OPTIONS")
	router.HandleFunc(urlCompetitionStart, handler.competitionStop).Methods("PUT", "OPTIONS")
	router.HandleFunc(urlCompetitionStart, handler.competitionVoterRegister).Methods("PUT", "OPTIONS")
}
